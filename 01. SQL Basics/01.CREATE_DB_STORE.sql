...
VALUES (11, 'Shivam Store', 70, 1.45);
...
SELECT first_name, last_name, points, (points + 10) as 'PT_DISCOUNT'
FROM customers
order by first_name;
...
select distinct customers.state
from customers;
...
SELECT *
FROM customers
WHERE last_name REGEXP 'field$'; -- $ - ENDING
...
SELECT *
FROM customers
WHERE last_name REGEXP '^field|burgh';

SELECT *
FROM customers
WHERE last_name REGEXP '[gim]e'; -- last ge , ie ,
